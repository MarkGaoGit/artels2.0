...
<div class="jq-show text-big">
    ...
    <div class="content-powerlong about-gg layout text-gray-666 <?php if($_GET['part'] == 'powerlong' || empty($_GET['part'])) { ?><?php } else { ?>hidden<?php } ?>">
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;由全国政协委员、中华全国工商业联合会副主席、澳门著名爱国实业家许健康先生于1990年在澳门创立。1992年开始投资祖国内地，现已发展成为集商业地产、酒店旅游业、信息业、工业、文化艺术业为一体的多元化大型外资企业集团。目前有近万名员工活跃在海内外100多家公司。</p>
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2003年起专注开发及经营高质量、大规模、多业态的综合性商业地产项目，其中主打产品“宝龙广场”获得了各地政府和公众的广泛关注与认可，不仅拉动了地方经济的发展，更完善了当地城市的功能配套，为社会提供了众多的就业机会，实现了人们对生活的需求和梦想，提升了城市的品位。</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;宝龙地产2009年在香港上市，截至2016年11月，宝龙地产在全国29座城市已拥有68个物业项目，其中长三角区域布局35个(上海15个)，目前在营中的商场达27个。</p>
        <a class="text-main text-default fr" target="_blank" href="http://www.powerlong.com">点击进入宝龙地产集团 ></a>
    </div>
    <!--宝龙酒店集团-->
    ...
    <div class="hotel-pinpai about-gg layout text-gray-666 <?php if($_GET['part'] != 'pinpai') { ?>hidden<?php } ?>">
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如今，宝龙旗下艺术酒店已形成“艺筑、艺悦、艺悦·精选、艺珺”系列品牌，涵盖商务型、中端、高端及豪华型多层级的艺术酒店，倾力打造场景式酒店艺术体验。</p>
