...
<div class="border-bottom mui-clearfix order-lh-40" style="">
<span class="mui-pull-left margin-small-right  padding-little-top">
<img src="<?php echo SKIN_PATH;?>statics/images/ico_23.png" width="24" />
</span>
请选择支付方式
</div>
...
<span class="mui-pull-left margin-small-right margin-top">
<img src="<?php echo SKIN_PATH;?>statics/images/ico_24.png" width="24" />
</span>
请选择并确认您的配送方式
</div>
...
_hddatas[hdkey]._pay_type_ = $("[data-id='type_box']").find(".hd-btn-blue").data("id");
var deliverys = {};
$("[data-sellerid]").each(function(i , n){
var _sellerid = $(this).data('sellerid');
deliverys[_sellerid] = $("[data-id='delivery_box']").find(".hd-btn-blue").attr("delivery-district-id");
})
_hddatas[hdkey]._deliverys_ = deliverys;
