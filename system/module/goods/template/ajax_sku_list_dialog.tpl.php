...
<script type="text/javascript" src="./statics/js/template.js" ></script>
		...
		<form action="<?php echo url('goods/sku/ajax_lists')?>" name="sku_search" method="get">
		...
		<div class="table border-none high-table opreate-table clearfix">
			...
			<div class="tr" data-id="<?php echo $sku['sku_id'] ?>" data-sn="<?php echo $sku['sn']?>" data-pic="<?php echo $sku['thumb'] ?>" data-title="<?php echo $sku['sku_name'] ?>" data-spec="<?php echo $sku['spec_show'] ?>" data-price="<?php echo $sku['shop_price'] ?>" data-number="<?php echo $sku['number'] ?>">
				<div class="td w45">
					<div class="td-con td-pic">
						<div class="pic"><img src="<?php echo $sku['thumb'] ?>" /></div>
						<div class="title text-ellipsis txt text-left"><?php echo $sku['sku_name']?></div>
						<div class="icon"><?php echo $sku['spec_show']?></div>
					</div>
				</div>
				<div class="td w20 text-left">
					<span class="td-con"><?php echo $sku['sn']?></span>
				</div>
				<div class="td w10"><?php echo $sku['shop_price']?></div>
				<div class="td w10"><?php echo $sku['number']?></div>
				<div class="td w15">
			...
			<%item = lists[item]%>
			<div class="tr" data-id="<%=item['sku_id']%>" data-sn="<%=item['sn']%>" data-pic="<%=item['thumb']%>" data-title="<%=item['sku_name']%>" data-spec="<%=item['spec_show']%>" data-price="<%=item['shop_price']%>" data-number="<%=item['number']%>">
				<div class="td w45">
					<div class="td-con td-pic">
						<div class="pic"><img src="<%=item['thumb']%>" /></div>
						<span class="title text-ellipsis txt text-left"><%=item['sku_name']%></span>
						<div class="icon"><%=item['spec_show']%></div>
					</div>
				</div>
				<div class="td w20 text-left">
					<span class="td-con"><%=item['sn']%></span>
				</div>
				<div class="td w10"><%=item['shop_price']%></div>
				<div class="td w10"><%=item['number']%></div>
				<div class="td w15">
