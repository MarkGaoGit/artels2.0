...
<div class="fixed-nav layout">
	<ul>
		<li class="first">艺术品列表<a id="addHome" title="添加到首页快捷菜单">[+]</a></li>
		<li class="spacer-gray"></li>
		<li><a class="labelbox" data-id="1" href="<?php echo url('index',array('label' => 1))?>">全部艺术品</a></li>
		<li><a class="labelbox" data-id="2" href="<?php echo url('index',array('label' => 2))?>">下架艺术品</a></li>
...
<div class="content padding-big have-fixed-nav">
	<div class="tips margin-tb">
		...
		<div class="tips-txt padding-small-top layout">
			<p>- 新增酒店后会生成所有规格艺术品，每一个规格艺术品均有独立属性，可自行修改</p>
		</div>
	</div>
	<div class="hr-gray"></div>
		...
		<form action="<?php echo __APP__?>" method="get">
			...
			<div class="top layout margin-bottom fl">
				...
				<div class="form-group form-layout-rank border-none" style="z-index: 2;">
					<span class="label">按艺术家查看</span>
					<div class="box" style="width: 150px;">
						<div class="form-select-edit select-search-text-box">
							<div class="form-buttonedit-popup">
								<input class="input" type="text" value="<?php echo $brand['name'] ? $brand['name'] : '选择'?>" readonly="readonly" data-reset="false">
								<span class="ico_buttonedit"></span>
								<input type="hidden" name="brand_id" value="<?php echo $brand['id']?>" data-reset="false">
							</div>
							<div class="select-search-field border border-main">
								<input class="input border-none" autocomplete="off" type="text" id="brandname" value="" placeholder="请输入名称" data-reset="false" />
				...
				<div class="form-group form-layout-rank border-none">
					...
					<div class="box ">
						<div class="field">
							<input class="input" type="text" name="keyword" value="<?php echo $_GET['keyword']?>" data-reset="false" placeholder="输入商品名称 或 货号" tabindex="0">
						</div>
					</div>
				</div>
	...
	<div class="table resize-table check-table paging-table high-table border clearfix">
		<div class="tr">
			...
			<div class="th" data-width="15">
				<div class="td-con">首页标题</div>
			</div>
			<div class="th" data-width="20">
				<div class="td-con">艺术品名称</div>
			</div>
			<div class="th" data-width="10">
				<div class="td-con">艺术家</div>
			</div>
			<div class="th" data-width="10">
				<div class="td-con">库存</div>
			</div>
			<div class="th" data-width="20">
				<div class="td-con">所在酒店信息</div>
			</div>
			<div class="th" data-width="5">
				<div class="td-con">前台样式</div>
			</div>
			<?php if($_GET['label'] == 1 || !isset($_GET['label'])){?>
				<div class="th" data-width="5">
		...
		<?php foreach ($goods as $r) {?>
			<div class="goods-list">
				<div class="tr">
					...
					<div class="td">
						<span class="td-con"><?php echo $r['web_style']?></span>
					</div>
					<?php if($_GET['label'] == 1 || !isset($_GET['label'])){?>
						<div class="td">
							<div class="td-con">
					...
					<div class="td">
						<div class="td-con double-row">
							<?php if(isset($_GET['label']) && $_GET['label'] != 1){?>
								<a target="_blank" href="<?php echo url('goods/index/worksDetail',array('sku_id'=>$r['sku_id']))?>">查看</a><br>
							<?php }else{?>
								<a target="_blank" href="<?php echo url('goods/index/worksDetail',array('sku_id'=>$r['sku_id']))?>">查看</a><br>
							<?php }?>
				...
				<script id="sku_info" type="text/html">
					...
					<div class="td">
						<div class="td-con double-row">
							<a target="_blank" href="?m=goods&c=index&a=worksDetail&sku_id=<%=item['sku_id']%>">查看</a><br>
