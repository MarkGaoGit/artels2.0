...
class cart_control extends init_control {
	...
	public function index() {
        ...
        $this->load->librarys('View')->display('cart');
	}
	...
	public function cart_add(){
		...
		if (empty($params)) showmessage(lang('order/parameter_empty'));
	...
	public function success() {
		...
		$this->load->librarys('View')->assign('SEO',$SEO);
        $this->load->librarys('View')->display('cart_success');
	}
	...
	public function goods_spec() {
        ...
        $this->load->librarys('View')->display('cart_popup');
	}
