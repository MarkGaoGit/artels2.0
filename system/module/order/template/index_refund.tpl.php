				...
				<div class="table resize-table paging-table high-table border clearfix">
					...
					<?php foreach ($infos['lists'] as $val) : ?>
						<div class="tr">
							...
							<span class="td">
								<span class="td-con"><?php echo $val['_type']; ?></span>
							</span>
							<span class="td">
							...
							<span class="td">
								<span class="td-con">
									<a href="<?php echo url('order/admin_server/detail_refund',array('refund_id' => $val['id'])) ?>"><?php if($val['status'] == 0): ?>处理<?php else: ?>查看<?php endif; ?></a>&emsp;
								</span>
							</span>
						</div>
					<?php endforeach; ?>
