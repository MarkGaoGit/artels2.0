<?php include template('header','admin');?>
		<div class="fixed-nav layout">
			<ul>
				<li class="first">totalArt导航设置</li>
				<li class="spacer-gray"></li>
				<li><a class="current" href="javascript:;">totalArt导航设置</a></li>
			</ul>
		...
		<div class="content padding-big have-fixed-nav">
			<div class="form-box clearfix">
				<?php echo Form::input('text', 'name', $info['name'], '导航名称：', '请填写totalArt导航的名称'); ?>
				<?php echo Form::input('text', 'url', $info['url'], '导航链接：', '请填写totalArt导航点击后跳转的地址'); ?>
