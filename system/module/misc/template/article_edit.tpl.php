<?php include template('header','admin');?>
		...
		<div class="content padding-big have-fixed-nav">
			...
			<div class="form-box clearfix">
				...
				<?php echo Form::input('text', 'keywords', $info['keywords'], '文章摘要：', '请用一段话描述本文文章的内容 <b style="color:#ff0000;">85字以内</b>'); ?>
				<?php echo Form::input('text', 'sort', $info['sort'] ? $info['sort'] : 100, '排序：', '请填写自然数，文章列表将会根据排序进行由小到大排列显示'); ?>
				<?php echo Form::input('radio', 'is_top', isset($info['is_top']) ? $info['is_top']: 0, '是否置顶：', '文章是否置顶显示', array('items' => array('1'=>'是','0'=> '否'), 'colspan' => 2,)); ?>
				<?php echo Form::input('calendar', 'dataline', isset($info['dataline'])? date('Y-m-d H:i:s',$info['dataline']) : $sds , '文章发布时间', '文章发布时间 不选为当前时间'); ?>
			</div>
			<div class="padding">
