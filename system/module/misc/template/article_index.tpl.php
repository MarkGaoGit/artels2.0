		...
		<div class="content padding-big have-fixed-nav">
			...
			<div class="table-work border margin-tb">
				<div class="border border-white tw-wrap">
					<a href="<?php echo url('add',array('types'=>$_GET['types'])) ?>"><i class="ico_add"></i>添加</a>
			...
			<div class="table resize-table check-table treetable border clearfix">
				...
				<div class="tr" data-tree-id="<?php echo $value['id']?>">
					...
					<div class="td">
						<span class="td-con"><span class="td-con"><a href="<?php echo url('edit',array('id'=>$value['id'],'types'=>$_GET['types']))?>">编辑</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo url('delete',array('id[]'=>$value['id']))?>" data-confirm="是否确认删除？">删除</a></span></span>
					</div>
				</div>
				<?php }?>
			</div>
