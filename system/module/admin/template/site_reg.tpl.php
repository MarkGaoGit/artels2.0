<?php include template('header','admin');?>
		...
		<div class="content padding-big have-fixed-nav">
			<div class="form-box clearfix">
				...
				<?php echo Form::input('checkbox', 'reg_user_fields[]',unserialize($setting['reg_user_fields']), '注册信息填写：', '注册时是否需要填写邮箱及手机，填写后如配置邮件及短信，则需要进行验证后方能注册成功', array('items' => array('email'=>'邮箱注册','phone'=> '手机注册'), 'colspan' => 1,)); ?>
				...
				<?php echo Form::input('checkbox', 'reg_pass_complex[]', unserialize($setting['reg_pass_complex']), '强制密码复杂度：', '新用户注册时密码中必须存在所选字符类型，不选则为无限制', array('items' => array('num'=>'数字','small'=> '小写字母', 'big'=>'大写字母','sym'=>'符号'), 'colspan' => 1,)); ?>
