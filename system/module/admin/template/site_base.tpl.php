...
<div class="content padding-big have-fixed-nav">
    <div class="content-tabs">
		...
		<?php echo Form::input('text', 'com_mobile', $setting['com_mobile'], '客服电话：', '客服电话 将显示在页面底部的联系方式处'); ?>
...
', array('items' => array(1 => '在线支付 + 货到付款', 2 => '仅在线支付', 3 => '仅货到付款'))); ?>
			<?php echo Form::input('checkbox', 'pays[]', implode(',', unserialize($setting['pays'])), '请选择支持的支付方式：', '设置在线支付时所支持的支付方式，需先在支付平台设置开启支付方式', array('items' => $payment)); ?>
...
', array('items' => array('订单下单成功时库存下降', '订单下单发货时库存下降'))); ?>
			...
			?>
			<?php echo Form::input('checkbox', 'balance_deposit[]', unserialize($setting['balance_deposit']), '请选择余额充值的支付方式：', '设置余额充值所支持的支付方式，需先在支付平台设置开启支付方式', array('items' => $payment, 'colspan' => 1, 'disabled' => 'alipay_escow')); ?>
        ...
        <div class="form-box clearfix for-invoice">
			...
			<?php echo Form::input('textarea', 'invoice_content', implode("\r\n",unserialize($setting['invoice_content'])), '发票内容设置：','客户要求开发票时可以选择的内容，每一行代表一个选项，例如：办公用品'); ?>
        </div>
    </div>
	<div class="content-tabs hidden">
        <div class="form-box clearfix">
