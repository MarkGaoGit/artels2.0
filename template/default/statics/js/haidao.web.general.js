	...
	/*$('.pub_input').bind('focus blur mouseover mouseout', function(event) {
        switch(event.type) {
            case 'focus':
                ...
                $(this).attr('style','border:1px solid #00447c;background-color:#e9fbfe;color:#000000;');
                break;
            case 'blur':
...
;(function($){
	...
	$.fn.tabs = function(options){
		...
		this.find("li").eq(options.show-1).addClass("current").siblings().removeClass("current hover-color");
		...
		this.find("li").bind(options.eventname,function(){
			$(this).addClass("current").siblings().removeClass("current hover-color");
	...
	$.fn.sliderShade = function(options){
		...
		var _width = options.width-(box_w-options.width)/6;
        ...
        /*
            if(options.arrow){
                var arrow = '';
                arrow += '<a class="prev" href="javascript:;"></a>';
                arrow += '<a class="next" href="javascript:;"></a>';
                _child.before(arrow);
            }
		*/
