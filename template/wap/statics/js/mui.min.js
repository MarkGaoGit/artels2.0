...
var mui = function(a, b) {
    ...
    function(a) {
        ...
        a.openWindow = function(b, c, f) {
            if ("object" == typeof b ? (f = b, b = f.url, c = f.id || b) : "object" == typeof c ? (f = c, c = b) : c = c || b, !a.os.plus) return void(window.top.location.href = b);
            if (window.plus) {
                f = f || {};
                var g, h, i = f.params || {},
                    j = null,
                ...
                k.afterShowMethodName && j.evalJS(k.afterShowMethodName + "('" + JSON.stringify(i) + "')"),
                    j;
                if (f.createNew !== !0 && (j = plus.webview.getWebviewById(c))) return g = a.showOptions(f.show),
                    j.show(g.aniShow, g.duration,
                        function() {
                            d(j),
                                e(j, "pagebeforeshow", !1)
                ...
                g.autoShow && j.addEventListener("loaded",
                    function() {
                        h && h.close(),
                            j.show(g.aniShow, g.duration,
                                function() {
            ...
            a.appendWebview = function(b) {
                if (window.plus) {
                    var c, d = b.id || b.url;
                    return a.webviews[d] || (c = plus.webview.create(b.url, d, b.styles, b.extras), plus.webview.currentWebview().append(c), a.webviews[d] = b),
                        c
                }
            },
            a.webviews = {},
            ...
            k = a.Class.extend({
                ...
                _initSnap: function() {
                    ...
                    for (var a = this.snaps,
                        ...
                        var k = a[j],
                            l = k.offsetLeft,
                            m = k.offsetWidth; (0 === j || l <= a[j - 1].offsetLeft) && (c = 0, d++),
                ...
                _initEvent: function(c) {
                    ...
                    e && mui(e)[c ? "off": "on"]("click", "a", a.preventDefault),
                        this.wrapper[d]("scrollend", this._handleIndicatorScrollend.bind(this)),
                        this.wrapper[d]("scrollstart", this._handleIndicatorScrollstart.bind(this)),
                        ...
                        if (this._clearRequestAnimationFrame(), "dragend" !== b.type || !c.flick) {
                            ...
                            if (this.isInTransition = !1, !this.resetPosition(this.options.bounceTime)) {
                                ...
                                return this.options.momentum && c.flickTime < 300 && (momentumX = this.hasHorizontalScroll ? this._momentum(this.x, c.flickDistanceX, c.flickTime, this.maxScrollX, this.options.bounce ? this.wrapperWidth: 0, this.options.deceleration) : {
                                    ...
                                    d != this.x || e != this.y ? ((d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) && (g = j.quadratic), void this.scrollTo(d, e, f, g)) : void a.trigger(this.scroller, "scrollend", this)
                            }
                        }
                    }
                },
            ...
            n = a.Slider = a.Scroll.extend({
                    ...
                    if (b.target === c.wrapper) {
                        ...
                        if (m) {
                            ...
                            if (n.length > 0) for (var g = 0,
                                                       h = n.length; h > g; g++) n[g].classList[g === d.slideNumber ? "add": "remove"](j);
                            else {
                                var o = m.querySelector(".mui-number span");
                                if (o) o.innerText = d.slideNumber + 1;
                                else for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++) p[g].classList[g === d.slideNumber ? "add": "remove"](j)
                            }
                        }
                        b.stopPropagation()
                    }
                ...
                _initEvent: function(b) {
                    ...
                    c.wrapper[d]("swiperight", a.stopPropagation),
                        ...
                        c.wrapper[d](a.eventName("shown", "tab"), c._handleTabShow.bind(this));
